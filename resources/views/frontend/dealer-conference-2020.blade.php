...
@section('content')
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-7 mission-vission-right">
                    <h4 class="wow fadeInUp" data-wow-duration="0.75s" data-wow-delay="0s">Dealer COnference of Universal
                        LPG</h4>
    ...
    <div class="main">
        ...
        <div class="row">
            <div class="column">
                <div class="content">
                    <img src="{{ url('frontend/assets/images/news/event1.1.jpg') }}" alt="Mountains" style="width:100%">

                </div>
            </div>
            <div class="column">
                <div class="content">
                    <img src="{{ url('frontend/assets/images/news/event1.2.jpg') }}" alt="Lights" style="width:100%">

                </div>
            </div>
            <div class="column">
                <div class="content">
                    <img src="{{ url('frontend/assets/images/news/event1.3.jpg') }}" alt="Nature" style="width:100%">

                </div>
            </div>
            <div class="column">
                <div class="content">
                    <img src="{{ url('frontend/assets/images/news/event1.4.jpg') }}" alt="Mountains" style="width:100%">

                </div>
            </div>
            <div class="column">
                <div class="content">
                    <img src="{{ url('frontend/assets/images/news/event1.5.jpg') }}" alt="Mountains" style="width:100%">

                </div>
            </div>
            <div class="column">
                <div class="content">
                    <img src="{{ url('frontend/assets/images/news/event1.7.jpg') }}" alt="Mountains" style="width:100%">

                </div>
            </div>
            <div class="column">
                <div class="content">
                    <img src="{{ url('frontend/assets/images/news/event1.6.jpg') }}" alt="Mountains" style="width:100%">

                </div>
            </div>
            <div class="column">
                <div class="content">
                    <img src="{{ url('frontend/assets/images/news/event1.8.jpg') }}" alt="Mountains" style="width:100%">
