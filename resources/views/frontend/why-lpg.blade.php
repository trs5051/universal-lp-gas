                ...
                <div class="row">
                    ...
                    <div class="col-md-5 mission-vission-left">
                        <figure class="wow fadeInUp" data-wow-duration="0.75s" data-wow-delay="0s">
                            <img src="{{ asset('/storage/information/' . $whyLPG->img1) }}" alt="mission-vission">
                        </figure>
                    </div>
                    <!-- /.mission-vission-left -->
                    ...
                    <div class="col-md-7 mission-vission-right">
                        <h4 class="wow fadeInUp" data-wow-duration="0.75s" data-wow-delay="0s">{{ $whyLPG->heading1 }}</h4>
                        <p class="wow fadeInUp" data-wow-duration="0.75s" data-wow-delay="0.1s">{{ $whyLPG->text1 }}</p>
                        <p class="wow fadeInUp" data-wow-duration="0.75s" data-wow-delay="0.2s">{{ $whyLPG->text2 }}</p>
                    </div>
                    <!-- /.mission-vission-left -->
                </div>
            </div>
