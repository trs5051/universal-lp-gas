...
@section('content')
                            ...
                            <div class="row proud-features">
                                ...
                                <div class="col-sm-6 single-pfeature">
                                    <figure class="icon wow fadeInUp" data-wow-duration="0.75s" data-wow-delay="0s">
                                        @isset($ourProud)
                                            <img src="{{ asset('/storage/ourProud/' . $ourProud->img1) }}"
                                                alt="proud-feature" />
                                        @endisset
                                    </figure>

                                    <div class="single-pfeature-text wow fadeInUp" data-wow-duration="0.75s"
                                        data-wow-delay="0s">
                                ...
                                <div class="col-sm-6 single-pfeature">
                                    <figure class="icon wow fadeInUp" data-wow-duration="0.75s" data-wow-delay="0s">
                                        @isset($ourProud)
                                            <img src="{{ asset('/storage/ourProud/' . $ourProud->img2) }}"
                                                alt="proud-feature" />
                                        @endisset
                                    </figure>
                                ...
                                <div class="col-sm-6 single-pfeature">
                                    <figure class="icon wow fadeInUp" data-wow-duration="0.75s" data-wow-delay="0s">
                                        @isset($ourProud)
                                            <img src="{{ asset('/storage/ourProud/' . $ourProud->img3) }}"
                                                alt="proud-feature" />
                                        @endisset
                                    </figure>
                                ...
                                <div class="col-sm-6 single-pfeature">
                                    <figure class="icon wow fadeInUp" data-wow-duration="0.75s" data-wow-delay="0s">
                                        @isset($ourProud)
                                            <img src="{{ asset('/storage/ourProud/' . $ourProud->img4) }}"
                                                alt="proud-feature" />
                                        @endisset
                                    </figure>
    ...
    <section class="business-concern-section sp">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-header text-center">
                        <h3 class="wow fadeInUp" data-wow-duration="0.75s" data-wow-delay="0s">Our business <span
                                class="colored">Concern</span></h3>
            ...
            <div class="row">
                <!-- concern-features -->
                <div class="col concern-features owl-carousel owl-theme wow fadeInUp" data-wow-duration="0.75s"
                    data-wow-delay="0s">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 sustainability-right">
                    ...
                    <div class="row best-fields">
                        ...
                        <!-- single-best-field -->
                        <div class="col-lg-6 col-md-12 col-sm-6 single-best-field wow fadeInUp" data-wow-duration="0.75s"
                            data-wow-delay="0s">
                            <figure class="icon">
