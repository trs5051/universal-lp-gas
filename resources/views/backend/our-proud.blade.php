...
@section('content')
    ...
    <section class="content-header">
        <h1>
            Our Proud Management
            <small>Edit Our Proud</small>
        </h1>
        <!-- Breadcrumbs would render from routes/breadcrumb.php -->
        <ol class="breadcrumb">
            <li><a href="{{ route('backend-home') }}">Dashboard</a></li>
            <li class="active">Edit Our Proud</li>
        </ol>
    ...
    <form method="POST" action="{{route('ourproud.store')}}" accept-charset="UTF-8" class="form-horizontal" role="form" id="edit-ourProud"
            ...
            <div class="box box-info">
                <div class="box-header">
                    <h3 class="box-title"><i class="fa fa-pencil-square"></i> Edit Our Proud</h3>
                    ...
                    <div id="myTabContent" class="tab-content setting-tab">
                        ...
                        <div role="tabpanel" class="tab-pane" id="tab2">
                            <div class="col-lg-5">
                                ...
                                <!--form control-->
                                <div class="form-group">
                                    <label for="number1" class="col-lg-2 control-label">Number 1</label>

                                    <div class="col-lg-10">
                                        <input class="form-control" placeholder="Number" name="number1" type="text"
                                             value="{{ $ourProud->number1 }}" id="number1">
                                    </div>
                                    <!--col-lg-10-->
                                </div>
                                <!--form control-->
                                ...
                                <!--form control-->
                                <div class="form-group">
                                    <label for="number2" class="col-lg-2 control-label">Number 2</label>

                                    <div class="col-lg-10">
                                        <input class="form-control" placeholder="Number2" name="number2" type="text"
                                             value="{{ $ourProud->number2 }}" id="number2">
                                    </div>
                                    <!--col-lg-10-->
                                </div>
                                <!--form control-->
                            ...
                            <div class="col-lg-5">
                                ...
                                <!--form control-->
                                <div class="form-group">
                                    <label for="number3" class="col-lg-2 control-label">Number 3</label>

                                    <div class="col-lg-10">
                                        <input class="form-control" placeholder="Number3" name="number3" type="text"
                                             value="{{ $ourProud->number3 }}" id="number3">
                                    </div>
                                    <!--col-lg-10-->
                                </div>
                                <!--form control-->
                                ...
                                <!--form control-->
                                <div class="form-group">
                                    <label for="number4" class="col-lg-2 control-label">Number 4</label>

                                    <div class="col-lg-10">
                                        <input class="form-control" placeholder="Meta Title" name="number4" type="text"
                                             value="{{ $ourProud->number4 }}" id="number4">
                                    </div>
                                    <!--col-lg-10-->
                                </div>
                                <!--form control-->
