...
@section('content')
    ...
    <section class="content-header">
        <h1>
            ...
            <small>Edit Mission and Vision</small>
        </h1>
        <!-- Breadcrumbs would render from routes/breadcrumb.php -->
        <ol class="breadcrumb">
            <li><a href="{{ route('backend-home') }}">Dashboard</a></li>
            <li class="active">Edit Mission and Vision</li>
        </ol>
    ...
    <section class="content">
        ...
        <form method="POST" action="{{ route('mission-vision.update') }}" accept-charset="UTF-8"
            class="form-horizontal" role="form" id="edit-concern" enctype="multipart/form-data">
            @csrf
            <div class="box box-info">
                <div class="box-header">
                    <h3 class="box-title"><i class="fa fa-pencil-square"></i> Edit Mission and Vision</h3>
                </div>
                <!-- /.box-header -->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <textarea class="form-control" placeholder="text1" rows="2"  name="text1"
                                cols="500" id="text1" style="max-width: 75% ; min-height: 100px;">{{ $concern->text1 }}</textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <textarea class="form-control" placeholder="text2" rows="2"  name="text2"
                                cols="500" id="text2" style="max-width: 75% ; min-height: 100px;">{{ $concern->text2 }}</textarea>
                        </div>
                    </div>
                </div>
