...
@section('content')
    ...
    <section class="content-header">
        <h1>
            US Energy & Power Pvt Ltd Management
            <small>Edit US Energy & Power Pvt Ltd</small>
        </h1>
        <!-- Breadcrumbs would render from routes/breadcrumb.php -->
        <ol class="breadcrumb">
            <li><a href="{{ route('backend-home') }}">Dashboard</a></li>
            <li class="active">Edit US Energy & Power Pvt Ltd</li>
        </ol>
        ...
        <form method="POST" action="{{ route('universal-lp-gas.update') }}" accept-charset="UTF-8"
            ...
            <div class="box box-info">
                <div class="box-header">
                    <h3 class="box-title"><i class="fa fa-pencil-square"></i> Edit US Energy & Power Pvt Ltd</h3>
                </div>
                <!-- /.box-header -->
