...
@section('content')
    ...
    <section class="content-header">
        <h1>
            Universal Agency Management
            <small>Edit Universal Agency</small>
        </h1>
        <!-- Breadcrumbs would render from routes/breadcrumb.php -->
        <ol class="breadcrumb">
            <li><a href="{{ route('backend-home') }}">Dashboard</a></li>
            <li class="active">Edit Universal Agency</li>
        </ol>
        ...
        <form method="POST" action="{{ route('universal-lp-gas.update') }}" accept-charset="UTF-8"
            ...
            <div class="box box-info">
                <div class="box-header">
                    <h3 class="box-title"><i class="fa fa-pencil-square"></i> Edit Universal Agency</h3>
                </div>
                <!-- /.box-header -->
