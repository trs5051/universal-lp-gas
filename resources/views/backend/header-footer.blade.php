        ...
        <form method="POST" action="{{ route('update-hearder-footer') }}" accept-charset="UTF-8" class="form-horizontal"
            ...
            <div class="box box-info">
                <div class="box-header">
                    <h3 class="box-title"><i class="fa fa-pencil-square"></i> Edit Header & Footer</h3>
                        ...
                        <div role="tabpanel" class="tab-pane active" id="tab1">
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    ...
                                    <div class="preview-logo">
                                        ...
                                        @isset($settings)
                                            <img src="{{ asset('/storage/logo/' . $settings->logo) }}" alt="Site Logo"
                                                width="200" />
                                        @endisset
                                    </div>
                                    <br>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    ...
                                    <br>
                                    <div class="custom-file-input">
                                        <input class="form-control inputfile inputfile-1" name="favicon" type="file"
                                            id="favicon">
                                        <label for="favicon">
                                            <i class="fa fa-upload"></i>
